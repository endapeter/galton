...
# Q-Q plotting functionality integrated for normality analysis per frame.
...
if __name__ == '__main__':
    ...
    for frame_idx, param_val in enumerate(sweep_values):
        ...
        # FIXED: Check if we are sweeping the drop range. 
        ...
        run_and_plot_galton_batch(
            ...
            param_val=param_val, # Note: Title will show the single parameter value, e.g. 4.5
